...
class TestConsumerIntegration(KafkaIntegrationTestCase):
    ...
    def test_equal_consumption(self):
        ...
        await self.send_messages(0, list(range(200)))
        await self.send_messages(1, list(range(200)))
    ...
    def test_consumer_position(self):
        ...
        # undefined
        position_task = asyncio.ensure_future(
            consumer.position(tp), loop=self.loop)
